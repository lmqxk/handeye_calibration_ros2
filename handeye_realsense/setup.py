...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'robot_piper = handeye_realsense.robot_state_piper:main',
            'auto_calibrate = handeye_realsense.auto_calibrate:main',
            'tcp_tf_bridge = handeye_realsense.tcp_tf_bridge:main',
        ],
    },
)
